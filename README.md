...
A personal portfolio site deployed on AWS via Terraform and GitHub Actions, using keyless OIDC authentication — no static AWS credentials stored anywhere.
